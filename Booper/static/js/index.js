...
function mostrarArquivo() {
	...
	arquivoSelecionado.innerHTML =
		...
		nome +
		"</p>" +
		'<span class="referencia">Está certo? Clique para continuar!</span>';
}
...
function lerArquivo() {
	botoesArquivoDIV.style =
		"box-shadow: 0px 0px 100vw 100vh rgba(0, 0, 0, 0.7), inset 0px 0px 0px 100vw rgba(0, 0, 0, 0.7)";
	arquivoSelecionado.style =
		" width: 400px; transform: scale(1.1) translateX(-140px);";
